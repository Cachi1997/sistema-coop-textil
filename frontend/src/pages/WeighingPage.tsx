...
//     if (e.key === "Enter") {
//       e.preventDefault();
//       console.log("Enter key pressed in input", index);
...
//           <form onSubmit={handleSubmit(registerWeight)} className="space-y-3">
//             <div>
//               <div className="p-3 mb-2 rounded-lg border-2 border-gray-600 bg-gray-750">
//                 <LabelDisplay
//                   message="Usuario"
//                   className="block text-sm font-medium mb-1 text-gray-300"
//                 />
...
//               <div className="p-3 mb-2 rounded-lg border-2 border-gray-600 bg-gray-750">
//                 <LabelDisplay
//                   message="Hilado (1) o Top (0)"
//                   className="block text-sm font-medium mb-1 text-gray-300"
//                 />
//                 <input
//                   type="number"
//                   {...register("isYarn", { required: true })}
//                   className={`w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded text-white focus:border-green-500 focus:outline-none ${
//                     errors.isYarn ? "border-red-500" : ""
//                   }`}
//                   ref={(el) => {
...
//                 <input
//                   type="number"
//                   {...register("ppe", { required: true })}
//                   className={`w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded text-white focus:border-green-500 focus:outline-none ${
//                     errors.ppe ? "border-red-500" : ""
//                   }`}
//                   ref={(el) => {
...
//               <div className="p-3 mb-2 rounded-lg border-2 border-gray-600 bg-gray-750">
//                 <LabelDisplay
//                   message="Tara Interna"
//                   className="block text-sm font-medium mb-1 text-gray-300"
//                 />
//                 <input
//                   type="number"
//                   {...register("internalTare", { required: false })}
//                   className={`w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded text-white focus:border-green-500 focus:outline-none ${
//                     errors.internalTare ? "border-red-500" : ""
//                   }`}
//                 />
//                 {errors.internalTare && (
//                   <span className="text-red-500 text-xs mt-1">
...
//               <div className="p-3 mb-2 rounded-lg border-2 border-gray-600 bg-gray-750">
//                 <LabelDisplay
//                   message="Tara Externa"
//                   className="block text-sm font-medium mb-1 text-gray-300"
//                 />
//                 <input
//                   type="number"
//                   {...register("externalTare", { required: false })}
//                   className={`w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded text-white focus:border-green-500 focus:outline-none ${
//                     errors.externalTare ? "border-red-500" : ""
//                   }`}
//                 />
//                 {errors.externalTare && (
//                   <span className="text-red-500 text-xs mt-1">
